 ...
 * @since 19.12.2020
 */
public final class Trash implements Storage {
    private final static String NAME = "Trash";
    private final static Math MATH = new Math();
    private final static double THRESHOLD_ADD = 1.0;
    private final static Predicate<Food> CAN_ADD_PRED = food -> {
        double ratio = MATH.ratio(food);
        return MATH.moreOrEquals(ratio, THRESHOLD_ADD);
    };
